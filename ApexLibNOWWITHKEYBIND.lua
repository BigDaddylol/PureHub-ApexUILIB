...
function ApexUITable:Category(name)
    ...
    function cat:KeyBind(name,default,callback) -- KeyBind
        ...
        KeyBindBox.Size = UDim2.new(0.981999993, 0, 0, 35)
        KeyBindBox.Image = "rbxassetid://3570695787"
        KeyBindBox.ImageColor3 = Color3.fromRGB(29, 29, 35)
        ...
        KeyBindName.Position = UDim2.new(0.00800000038, 0, 0, 2)
        KeyBindName.Size = UDim2.new(0.400000006, 0, 0, 30)
        ...
        KeyBindButton.Position = UDim2.new(1, -126, 0, 4)
        KeyBindButton.Size = UDim2.new(0, 120, 0, 26)
        KeyBindButton.AutoButtonColor = false
        KeyBindButton.Image = "rbxassetid://3570695787"
        KeyBindButton.ImageColor3 = Color3.fromRGB(21, 21, 26)

...
function ApexUITable:Category(name)
    ...
    function cat:KeyBind(name,default,callback) -- KeyBind
        ...
        KeyBindName.Position = UDim2.new(0.0168539323, 0, 0.09375, 0)
        KeyBindName.Size = UDim2.new(0, 250, 0.800000012, 0)
        KeyBindName.Font = Enum.Font.SourceSansSemibold
        ...
        KeyBindButton.Position = UDim2.new(0, 286, 0, 3)
        ...
        KeyBindKey.Parent = KeyBindButton
